...
<body>  
    ...
    <tbody> 
    <?php 
       $servurl="http://172.190.52.193:3003/alerta/usu/$us";
       ...
       <!-- echo "<script>confirm('Por favor completa todos los campos.');</script>"; -->
       <?php
        } 
    ?> 
    </tbody> 
    ...
    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable"> 
        ...
        <div class="modal-body"> 
            <form action="modificar_alertas_usuario.php" method="post"> 
            <div class="mb-3"> 
