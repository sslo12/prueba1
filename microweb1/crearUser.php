    ...
    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable"> 
        ...
        <div class="modal-body"> 
            ...
            <div class="mb-3"> 
                ...
                <input type="contrasena" name="contrasena" class="form-control" id="exampleInputPassword1"> 
            </div> 
            <div class="mb-3"> 
                <label for="exampleInputPassword1" class="form-label">Correo</label> 
                <input type="correo" name="correo" class="form-control" id="exampleInputPassword1"> 
            </div> 
            <div class="mb-3"> 
                <label for="exampleInputPassword1" class="form-label">Telefono1</label> 
                <input type="telefono1" name="telefono1" class="form-control" id="exampleInputPassword1"> 
            </div> 
            <div class="mb-3"> 
                <label for="exampleInputPassword1" class="form-label">T
                    elefono2</label> 
                <input type="telefono2" name="telefono2" class="form-control" id="exampleInputPassword1"> 
            </div> 
